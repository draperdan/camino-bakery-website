...
class Category(models.Model):
	...
	lead_image = models.ImageField(upload_to='images/lead_images', help_text='Upload an image to display as the lead image on the template. Image must be cropped for display at 1170px wide, 400px tall. Please use JPG or PNG formats. Will populate the width and height fields on save.', width_field='lead_image_width', height_field='lead_image_height', blank=True)
