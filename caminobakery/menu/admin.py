...
from .models import Item, Size, ItemType, ItemTypeGroup, BreadSchedule, Day
...
class ItemAdmin(admin.ModelAdmin):
	...
	fieldsets = (
		(None, {
			'fields': ('name', 'slug', 'description', 'status', 'one_off_price',)
		}),
		('Photo', {
		...
		('Additional classification', {
			'classes': ('collapse',),
			'fields': ('is_flourless', 'is_vegan', 'is_seasonal', 'is_available', 'vegan_option_available', 'flourless_option_available')
		}),
	)
...
class ItemTypeAdmin(admin.ModelAdmin):
	...
	fieldsets = (
		(None, {
			'fields': ('title', 'slug', 'description', 'lead_image', 'lead_image_width', 'lead_image_height')
		}),
	)
	inlines = [
		SizeInline,
...
class ItemTypeGroupAdmin(admin.ModelAdmin):
	prepopulated_fields = {'slug': ('title',),}
	fields = ('title', 'slug', 'description', 'item_types', 'lead_image', 'lead_image_width', 'lead_image_height')
