...
class AlcoholView(ListView):
    ...
    queryset = ItemType.objects.filter(
        itemtypegroup__title__exact="Wine & Beer")
    template_name = "menu/alcohol_list.html"

    def get_context_data(self, **kwargs):
        context = super(AlcoholView, self).get_context_data(**kwargs)
        context['alcohol_group'] = get_list_or_404(ItemTypeGroup,
                                                   title__exact="Wine & Beer")
        return context
...
class CakesView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['cake_group'] = get_list_or_404(ItemTypeGroup,
                                                title__exact="Cakes")
        return context
...
class CateringView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['catering_group'] = get_list_or_404(ItemTypeGroup,
                                                    title__exact="Catering")
        return context
...
class ItemListView(ListView):
    ...
    queryset = ItemTypeGroup.objects.exclude(
        item_types__title__contains="Cakes").exclude(
            item_types__title__contains="Catering").exclude(
                item_types__title__contains="Bread").exclude(
                    title__exact="Wine & Beer")
...
class SandwichView(ListView):
    ...
    queryset = ItemType.objects.filter(title__contains="Sandwiches")
    template_name = "menu/sandwich_list.html"

    def get_context_data(self, **kwargs):
        context = super(SandwichView, self).get_context_data(**kwargs)
        context['sandwich_type'] = get_list_or_404(ItemType,
                                                   title__exact="Sandwiches")
        return context
...
class BreadView(ListView):
    ...
    queryset = ItemType.objects.filter(title__exact="Bread")
    ...
    def get_context_data(self, **kwargs):
        ...
        context['bread_type'] = get_list_or_404(ItemType,
                                                title__exact="Bread")
        return context
